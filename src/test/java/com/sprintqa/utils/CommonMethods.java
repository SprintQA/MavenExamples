...
public class CommonMethods{
	 ...
	 */
	public void selectByIndex(WebElement element, int index) { // method overloading
	...
	/**
	 * Example of method throwing exception letting the test handle the exception.
	 * 
	 * @param fileName
	 * @throws IOException
	 */
	...
	public void waitForPresenceOfElementLocated(By locator, int time) {
		WebDriverWait wait = new WebDriverWait(getWebDriver(), time);
	...
	public void waitForPageToLoad(long time, TimeUnit unit) {
